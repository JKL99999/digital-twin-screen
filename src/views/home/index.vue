    ...
    <div class="header">
      ...
      <div class="header-content">
        <div class="header-left">
          <span class="time"><i class="icon-clock"></i> 2025-11-26 星期三 09:25:38</span>
          <span class="weather"><i class="icon-sun"></i> 晴天 6℃</span>
        </div>
    ...
    <div class="main_content">
      ...
      <div class="main_content_left">
          ...
          <div class="progress-container">
            ...
            <div class="chart-area">
              ...
              <div class="chart-legend">
                <div class="legend-item"><span class="dot done"></span> 完成 2789</div>
                <div class="legend-item"><span class="dot todo"></span> 未完成 75</div>
              </div>
            </div>
            
            <!-- Right: Bars -->
            <div class="bars-area">
              <div class="bar-item" v-for="(item, index) in progressData" :key="index">
                <div class="bar-info">
        ...
        <div class="panel-box zone-section">
          <div class="zone-grid">
            <div class="zone-card" v-for="(zone, index) in zoneData" :key="index">
              ...
              <div class="zone-progress">
                <div class="progress-bg">
                  <div class="progress-fill" :style="{ width: zone.percent }"></div>
                </div>
              </div>
      ...
      <div class="main_content_right">
        ...
        <div class="floating-panel acceptance-list">
          ...
          <div class="fp-content">
            <div class="list-item">
              <span class="dot-blue"></span> 2025年3月20日
            </div>
            <div class="list-item">
              <span class="dot-white"></span> 2025年3月21日
            </div>
          </div>
        </div>
...
.dashboard-container {
  width: 100vw;
  height: 100vh;
  background: radial-gradient( 91% 91% at 89% 132%, rgba(23,159,222,0.2) 0%, rgba(23,159,222,0) 100%), radial-gradient( 51% 51% at 28% 96%, rgba(23,159,222,0.2) 0%, rgba(23,159,222,0) 100%), #0E1A2A;
  color: $text-primary;
...
.top_nav {
  ...
  .nav-tabs {
    ...
    .tab-item {
      padding: 8px 30px;
      background: linear-gradient(180deg, rgba(10,50,90,0.8), rgba(5,20,40,0.8));
  ...
  .main_content_left {
    ...
    .panel-box {
      ...
      &::before {
         ...
         border-top: 2px solid $text-secondary; border-left: 2px solid $text-secondary;
      }
      ...
      .progress-container {
        ...
        .chart-area {
          ...
          .donut-chart {
            ...
            .percentage { font-size: 20px; font-weight: bold; color: #fff; }
            .label { font-size: 10px; color: #8ab; }
          }
        ...
        .bars-area {
          ...
          .bar-item {
             ...
             .bar-info {
               display: flex; justify-content: space-between; color: #a0cfff; margin-bottom: 2px;
             }
             .progress-bg {
             ...
             .progress-fill {
               height: 100%; background: linear-gradient(90deg, #0096ff, #00deff);
             }
          }
        }
      }
    ...
    .zone-section {
      ...
      .zone-grid {
        ...
        .zone-card {
          ...
          .zone-header {
            display: flex; align-items: center; gap: 5px; font-size: 13px; color: #fff; margin-bottom: 5px;
          }
          .progress-bg {
             height: 4px; background: #333; margin-bottom: 5px;
             .progress-fill { height: 100%; background: $text-secondary; }
          }
          .zone-stats {
            display: flex; justify-content: space-between; font-size: 12px; color: #8ab;
            .percent-text { color: $text-secondary; }
          }
        }
      }
    }
    ...
    .quantity-section {
       .panel-header-sm {
         display: flex; justify-content: space-between; align-items: center; font-size: 14px; font-weight: bold; margin-bottom: 8px; color: #fff;
         .header-right-text { font-size: 10px; color: #8ab; font-weight: normal; }
       }
       .quantity-table {
          font-size: 12px;
          .q-row {
             display: flex; justify-content: space-between; padding: 6px 0; border-bottom: 1px dashed rgba(255,255,255,0.1);
             &:last-child { border-bottom: none; }
          }
          .header-row { color: $text-secondary; border-bottom: 1px solid $border-blue; margin-bottom: 5px;}
          .sub-header { color: #8ab; }
          .highlight { color: $text-secondary; }
          
          .pagination-dots {
            display: flex; justify-content: center; gap: 5px; margin-top: 5px;
            span { width: 6px; height: 6px; background: #555; border-radius: 50%; 
  ...
  .main_content_right {
    ...
    .acceptance-list {
      ...
      .fp-content {
        padding: 10px;
        .list-item {
          display: flex; align-items: center; gap: 10px; font-size: 12px; margin-bottom: 8px; color: #fff;
          .dot-blue { width: 8px; height: 8px; border-radius: 50%; background: $text-secondary; }
          .dot-white { width: 8px; height: 8px; border-radius: 50%; background: #fff; }
        }
      }
    }
